...
#include "libre-impuesto-string.h"
...
gboolean
libre_impuesto_string_to_int (const char *string, gulong *integer)
{
	gulong result;
	char *parse_end;
...
char *
libre_impuesto_string_blank_chr (char *source)
{
	char *p;
...
char *
libre_impuesto_string_shorten (char *str,
		     gsize target_length)
{
        char *new_str;
        glong actual_length;
...
char*
libre_impuesto_string_collate_key_for_domain (const char *str,
				    gssize len)
{
	GString *result;
	const char *dot;
...
guint
libre_impuesto_string_flags_from_string (GType type,
...
char *
libre_impuesto_string_flags_to_string (GType type,
			     guint flags_value)
{
	GFlagsClass *flags_class;
	GString *string;
...
guint
libre_impuesto_string_enum_from_string (GType type,
...
char *
libre_impuesto_string_enum_to_string (GType type,
			    guint enum_value)
{
	GEnumClass *enum_class;
	GEnumValue *value;
...
char *
libre_impuesto_string_canonicalize_pathname (const char *cpath)
{
	char *path;
	int i, marker;
...
char *
libre_impuesto_string_get_host_name (const char *url)
{
	SoupURI *uri;
	char *ret;
...
char *
libre_impuesto_string_expand_initial_tilde (const char *path)
{
...
char **
libre_impuesto_string_commandline_args_to_uris (char **arguments, GError **error)
{
	gchar **args;
	GFile *file;
	guint i;
