...
int
libre_impuesto_profile_utils_get_migration_version ()
{
  ...
  migrated_file = g_build_filename (libre_impuesto_dot_dir (),
...
gboolean
libre_impuesto_profile_utils_set_migration_version (int version)
{
  ...
  if (result == FALSE)
    LOG ("Couldn't store migration version %d in %s (%s, %s)",
         version, migrated_file, libre_impuesto_dot_dir (), PROFILE_MIGRATION_FILE);
...
void
_libre_impuesto_profile_utils_store_form_auth_data (const char *uri,
                                          const char *form_username,
                                          const char *form_password,
                                          const char *username,
                                          const char *password)
...
void
_libre_impuesto_profile_utils_query_form_auth_data (const char *uri,
                                          const char *form_username,
                                          const char *form_password,
