...
#define GTK_STACK_GET_PRIVATE(obj) \
	(G_TYPE_INSTANCE_GET_PRIVATE \
	((obj), GTK_TYPE_STACK, GtkStackPrivate))
...
GType
gtk_stack_transition_get_type (void)
{
...
gtk_stack_finalize (GObject *obj)
{
  ...
  GtkStackPrivate *priv = GTK_STACK_GET_PRIVATE (obj);
                       ...
                       GParamSpec *pspec)
{
  ...
  //GtkStackPrivate *priv = gtk_stack_get_instance_private (stack);
  GtkStackPrivate *priv = GTK_STACK_GET_PRIVATE (object);
...
gtk_stack_realize (GtkWidget *widget)
{
  ...
  //GtkStackPrivate *priv = gtk_stack_get_instance_private (stack);
  GtkStackPrivate *priv = GTK_STACK_GET_PRIVATE (G_OBJECT(stack));
  GtkAllocation allocation;
...
gtk_stack_class_init (GtkStackClass *klass)
{
  ...
  g_type_class_add_private (object_class, sizeof (GtkStackPrivate));
}
