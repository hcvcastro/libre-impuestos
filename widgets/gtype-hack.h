 ...
 */
#ifndef __G_TYPE_HACK_H__
#define __G_TYPE_HACK_H__
 ...
 * a *_get_type() function. See G_DEFINE_TYPE_EXTENDED_HACK() for an example.
 * 
 * Since: 2.4
 */
#define G_DEFINE_TYPE_HACK(TN, t_n, T_P)			    G_DEFINE_TYPE_EXTENDED_HACK (TN, t_n, T_P, 0, {})
/**
 * G_DEFINE_TYPE_WITH_CODE_HACK:
 * @TN: The name of the new type, in Camel case.
 ...
 * Similar to G_DEFINE_TYPE_HACK(), but allows you to insert custom code into the 
 * *_get_type() function, e.g. interface implementations via G_IMPLEMENT_INTERFACE().
 * See G_DEFINE_TYPE_EXTENDED_HACK() for an example.
 * 
 * Since: 2.4
 */
#define G_DEFINE_TYPE_WITH_CODE_HACK(TN, t_n, T_P, _C_)	    _G_DEFINE_TYPE_EXTENDED_BEGIN_HACK (TN, t_n, T_P, 0) {_C_;} _G_DEFINE_TYPE_EXTENDED_END()
/**
 ...
 * instance data to the type. Furthermore, it defines a *_get_type() function. See G_DEFINE_TYPE_EXTENDED_HACK()
 * for an example.
 * 
 ...
 * Since: 2.38
 */
#define G_DEFINE_TYPE_WITH_PRIVATE(TN, t_n, T_P)            G_DEFINE_TYPE_EXTENDED_HACK (TN, t_n, T_P, 0, G_ADD_PRIVATE (TN))
/**
 * G_DEFINE_ABSTRACT_TYPE_HACK:
 * @TN: The name of the new type, in Camel case.
 * @t_n: The name of the new type, in lowercase, with words 
 *  separated by '_'.
 * @T_P: The #GType of the parent type.
 * 
 * A convenience macro for type implementations. 
 * Similar to G_DEFINE_TYPE_HACK(), but defines an abstract type. 
 * See G_DEFINE_TYPE_EXTENDED_HACK() for an example.
 * 
 * Since: 2.4
 */
#define G_DEFINE_ABSTRACT_TYPE_HACK(TN, t_n, T_P)		    G_DEFINE_TYPE_EXTENDED_HACK (TN, t_n, T_P, G_TYPE_FLAG_ABSTRACT, {})
/**
 * G_DEFINE_ABSTRACT_TYPE_WITH_CODE_HACK:
 * @TN: The name of the new type, in Camel case.
 * @t_n: The name of the new type, in lowercase, with words 
 *  separated by '_'.
 * @T_P: The #GType of the parent type.
 ...
 * 
 * A convenience macro for type implementations.
 * Similar to G_DEFINE_TYPE_WITH_CODE_HACK(), but defines an abstract type and allows you to 
 * insert custom code into the *_get_type() function, e.g. interface implementations 
 * via G_IMPLEMENT_INTERFACE(). See G_DEFINE_TYPE_EXTENDED_HACK() for an example.
 * 
 * Since: 2.4
 */
#define G_DEFINE_ABSTRACT_TYPE_WITH_CODE_HACK(TN, t_n, T_P, _C_) _G_DEFINE_TYPE_EXTENDED_BEGIN_HACK (TN, t_n, T_P, G_TYPE_FLAG_ABSTRACT) {_C_;} _G_DEFINE_TYPE_EXTENDED_END()
/**
 ...
 * Since: 2.38
 */
#define G_DEFINE_ABSTRACT_TYPE_WITH_PRIVATE(TN, t_n, T_P)   G_DEFINE_TYPE_EXTENDED_HACK (TN, t_n, T_P, G_TYPE_FLAG_ABSTRACT, G_ADD_PRIVATE (TN))
/**
 * G_DEFINE_TYPE_EXTENDED_HACK:
 * @TN: The name of the new type, in Camel case.
 * @t_n: The name of the new type, in lowercase, with words
 *    separated by '_'.
 * @T_P: The #GType of the parent type.
 ...
 * G_DEFINE_TYPE_HACK(), etc are based.
 *
 * |[
 * G_DEFINE_TYPE_EXTENDED_HACK (GtkGadget,
 *                         gtk_gadget,
 *                         GTK_TYPE_WIDGET,
 *                         0,
 ...
 * Since: 2.4
 */
#define G_DEFINE_TYPE_EXTENDED_HACK(TN, t_n, T_P, _f_, _C_)	    _G_DEFINE_TYPE_EXTENDED_BEGIN_HACK (TN, t_n, T_P, _f_) {_C_;} _G_DEFINE_TYPE_EXTENDED_END()
 ...
 * G_DEFINE_TYPE_EXTENDED_HACK() for a similar example using
 * G_DEFINE_TYPE_WITH_CODE_HACK().
 *
 * Since: 2.24
 */
 ...
 * of G_DEFINE_TYPE_WITH_CODE_HACK() or G_DEFINE_ABSTRACT_TYPE_WITH_CODE_HACK().
 * See G_DEFINE_TYPE_EXTENDED_HACK() for an example.
 *
 ...
 * in the @_C_ section of G_DEFINE_TYPE_WITH_CODE_HACK() or
 * G_DEFINE_ABSTRACT_TYPE_WITH_CODE_HACK().
 *
 * For instance:
 *
 ...
 *   } MyObjectPrivate;
 *
 *   G_DEFINE_TYPE_WITH_CODE_HACK (MyObject, my_object, G_TYPE_OBJECT,
...
#define _G_DEFINE_TYPE_EXTENDED_BEGIN_HACK(TypeName, type_name, TYPE_PARENT, flags) \
\
